...
// Local definitions
  ...
  #define DC_OFFSET  210                                                        // DC offset in mic signal. I subtract this value from the raw sample of a 'quiet room' test.
...
//    float sampli, value, envelope ;                                           // Le détecteur de BPM adapté de Damian Peckett. Marche po très bien.
//
//        sampli = micIn ;//(int16_t)analogRead(0)-DC_OFFSET;
//    
//        // Filter only bass component
//        value = bassFilter(sampli);
//    
