...
// Temporary local variables
  uint8_t allfreq = 64;                                                         // You can change the frequency, thus distance between bars. Wouldn't recommend changing on the fly.
  uint8_t thiscutoff = 125;                                                     // You can change the cutoff value to display this wave. Lower value = longer wave.
 

  thiscutoff = 125 - sampleavg;
